...
<div class="nr_list">
       ...
       <li style="width:100px"><?php echo $row->title;?></li>
       <li style="width:30px">mrp</li>
       ...
       <li style="width:100px" title="<?php echo $row->bb; ?>"><?php echo mb_substr($row->bb,0,4)?></li>
   ...
   <?php echo $this->pagination->create_links();?>
      <li> 
   <form id="form2" method="post"  action="index.php/welcome/mrp">
...
应用名称：<input type="text" name="title"/><hr>
...
应用分类：<input type="radio" name="fl" value="1" checked/>精品推荐  <input type="radio" name="fl" value="2">编辑推荐<hr>
